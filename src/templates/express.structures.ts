...
export const expressTypeScriptStructure: FolderStructure = {
  id: 'express-typescript',
  name: 'Express TypeScript Architecture',
  description:
    'Express application structure optimized for TypeScript with organized configs, types, and middleware',
  framework: 'express',
